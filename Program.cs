...
namespace Clenvon
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Welcome to Clenvon 2021 Version 1.0.1!\n");
            while (true)
            {
                ...
                if (command.Contains("compile"))
                {
                    ...
                    else
                    {
                        ...
                        {
                            Instructions[] headers = GetFile.GetHeaderFilesFromInclude(instructions);
                            ReadableInstructions[] readableInstructs = InstructionTools.CreateReadableInstructions(headers);
                ...
                {
                    Console.WriteLine("Installed Clenvon version: 1.0.1");
                }
                ...
                {
                    Console.WriteLine("Clenvon 2021, Version 1.0.1");
                    Console.WriteLine("Repository: https://github.com/megaaabytes/clenvon");
                    Console.WriteLine("Author: Megaaabytes");
                    Console.WriteLine("Clenvon source code is licensed under GNU GPL 3.0.");
